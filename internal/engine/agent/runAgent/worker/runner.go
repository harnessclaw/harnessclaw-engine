...
// it falls back to the stub (writes a summary file and meta.json).
...
// runStub is a test/fallback skeleton: writes a one-line summary of the goal
// + meta.json and returns. Used when no SpawnFn is wired (e.g. e2e tests).
