...
import (
	...
	"harnessclaw-go/internal/engine/agent/scheduler/dispatch/plan"
	"harnessclaw-go/internal/engine/agent/scheduler/dispatch/react"
	"harnessclaw-go/internal/engine/agent/scheduler/runtime"
	"harnessclaw-go/internal/engine/agent/scheduler/runtime/host"
...
// NewScheduler wires all strategies and returns a Scheduler ready for Start.
