...
// callLLM needs to attribute its heartbeat / retry events to the
...
// fields directly to callLLM — they fish them out of ctx instead.
//
...
// Both fields are optional — callLLM handles zero values gracefully
...
// downstream callLLM invocations (in planner / resolver / any
...
// callLLM is fine with empty agentID and nil out, so callers
// don't need to gate.
