...
func TestNewServer_MountsModelsHandler(t *testing.T) {
	...
	s := NewServer(ServerConfig{Host: "127.0.0.1", Port: 0}, nil, nil, modelsHandler, nil, nil /* toolsHandler */, nil /* videoGenHandler */, nil /* artifactsHandler */, nil /* capabilitiesHandler */, zap.NewNop())
